  ...
  return (
    <div className="container bg-success bg-opacity-25 login-container my-5 shadow">
      ...
      <form className="login-container" onSubmit={handleSubmit(onSubmit)}>
        ...
        <br />
        <input
          className="btn-submit input-btn btn-danger fs-5"
          type="submit"
          value="Login"
        />
        <br />
        <button onClick={signInUsingGoogle} className="btn-submit input-btn btn-danger fs-5 ">
          Google Sign-in
        </button>
        <br />
        <button className="btn-submit input-btn btn-danger fs-5">
          Facebook log-in
        </button>
